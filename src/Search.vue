    ...
    fetchData() {
      ...
      fetch(apiUrl)
        ...
        .then(data => {
          ...
          switch (this.sort) {
            case 'az':
              this.booksData.sort((a, b) => a.title.localeCompare(b.title));
            break
            case 'za':
              this.booksData.sort((b, a) => a.title.localeCompare(b.title));
            break
            case 'best':
              this.booksData.sort((a, b) => b.ratings_average - a.ratings_average);
              break;
            case 'worst':
              this.booksData.sort((b, a) => b.ratings_average - a.ratings_average);
              break;
          }

          if (this.filter != "") {
            this.booksData = this.booksData.filter((book) => book.subject.includes(this.filter));
          }
